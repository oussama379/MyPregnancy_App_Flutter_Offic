                ...
                children: <Widget>[
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return AppLocalizations.of(context)!.translate(
                              'login_page_email_field_error_noValue');
                        }
                        return null;
                      },
                  ...
                  TextButton(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!
                          .translate('login_page_forgot_button'),
                    ...
                    child: TextButton(
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          _loginService.signInWithEmailAndPassword(context,
                  ...
                  Container(
                    ...
                    child: TextButton(
                      ...
                      child: Text(
                        AppLocalizations.of(context)!
                            .translate('login_page_create_button'),
